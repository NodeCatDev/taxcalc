		...
		<div className="min-h-screen bg-gray-50 py-12 px-4">
			<div className="max-w-3xl mx-auto">
				...
				<section className="mb-10 text-gray-700 leading-relaxed">
					<p className="mb-4">
						本シミュレーターでは、副業によって増える 「所得税・復興特別所得税・住民税（所得割）」の
						概算額を自動計算できます。
					</p>
					<p>
				...
				<section className="mt-16">
					...
					<div className="space-y-6 text-gray-700">
						<div>
							<h3 className="font-semibold mb-2">Q. 副業が20万円以下なら確定申告は不要ですか？</h3>
							<p>
						...
						<div>
							<h3 className="font-semibold mb-2">Q. 副業の住民税は会社に知られますか？</h3>
							<p>
						...
						<div>
							<h3 className="font-semibold mb-2">Q. 副業が赤字の場合はどうなりますか？</h3>
							<p>
						...
						__html: JSON.stringify({
							...
							mainEntity: [
								...
								},
								{
									...
									acceptedAnswer: {
										'@type': 'Answer',
										text: '住民税を普通徴収にすることで会社に通知されない方法もあります。詳細はお住まいの自治体へご確認ください。',
									},
								},
								{
									'@type': 'Question',
									...
									acceptedAnswer: {
										'@type': 'Answer',
										text: '本シミュレーターでは副業が赤字の場合は税額増加なしとして計算しています。実際の取り扱いは所得区分により異なります。',
									},
								},
							],
						}),
